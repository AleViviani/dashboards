...
#https://discuss.streamlit.io/t/not-able-to-implement-hover-callback-in-bokeh-on-streamlit/11315/3
import pathlib
import shutil
...
for p in os.listdir(os.path.join(EXPERIMENT_FOLDER, IMAGES_FOLDER)):
    if not (PNG_PATH / p).exists():
        shutil.copy(os.path.join(EXPERIMENT_FOLDER, IMAGES_FOLDER, p), PNG_PATH / p)
